...
def article_list_create_api_view(request):
    ...
    if request.method == "GET":
        articles = Article.objects.filter(active=True)#queryset
        serializer = ArticleSerializer(articles, many=True)#alimentar al serializer con el queryset obtenido, y busca en el qs completo.
        return Response(serializer.data)
